    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tuesdaySelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count % 2 == 0) {
                    tuesdayItem.setText("Cornflakes\n" +
                            "Bread/Butter/Jam\n" +
                            "Tea/Coffee/Milk\n" +
                            "Papaya\n" +
                            "Chole Bathure\n" +
        ...
        wednesdaySelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count % 2 == 0) {
                    wednesdayItem.setText("Cornflakes\n" +
                            "Bread/Butter/Jam\n" +
                            "Tea/Coffee/Milk\n" +
                            "Banana\n" +
                            "Idly\n" +
        ...
        thursdaySelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count % 2 == 0) {
                    thursdayItem.setText("Cornflakes\n" +
                            "Bread/Butter/Jam\n" +
                            "Tea/Coffee/Milk\n" +
                            "Watermelon\n" +
                            "Aloo Paratha\n" +
        ...
        saturdaySelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (count % 2 == 0) {
                    saturdayItem.setText("Cornflakes\n" +
                            "Bread/Butter/Jam\n" +
                            "Tea/Coffee/Milk\n" +
                            "Pineapple\n" +
                            "Gobi Paratha\n" +
